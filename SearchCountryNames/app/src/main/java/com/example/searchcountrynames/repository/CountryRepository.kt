package com.example.searchcountrynames.repository
...
class CountryRepository {
    ...
    init {
        val name = arrayListOf("Afghanistan", "Albania", "Algeria", "American Samoa", "Andorra", "Angola", "Anguilla",
